...
public class Utils {
	 ...
	 * @return
	 */
	public synchronized static String getLocationStr(AMapLocation location ,LocationVo vo){
		if(null == location){
			return null;
		}
		...
		if(location.getErrorCode() == 0){
			...
			vo.setLocationType(String.valueOf(location.getLocationType()));
			...
			vo.setPoiName(location.getPoiName());
			...
			vo.setErrorInfo(location.getErrorInfo());
